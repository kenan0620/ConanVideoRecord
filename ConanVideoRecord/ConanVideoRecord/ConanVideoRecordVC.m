...
@interface ConanVideoRecordVC ()<AVCaptureFileOutputRecordingDelegate>//视频文件输出代理
...
@implementation ConanVideoRecordVC
{
...
- (void)viewDidLoad {
    ...
    preLayerHeight = SCREEN_HEIGHT-68;
...
-(void)initCapture{
    ...
    btView.center = CGPointMake(SCREEN_WIDTH/2, 64+preLayerHeight-120);
    [btView ConanMakeCornerRadius:43 BorderColor:nil BorderWidth:0 BackgroundColor:UIColorFromRGB(0xeeeeee)];
    [self.viewContainer addSubview:btView];
    ...
    [shootBt ConanMakeCornerRadius:38 BorderColor:UIColorFromRGB(0x28292b) BorderWidth:3 BackgroundColor:UIColorFromRGB(0xfa5f66)];
    [btView addSubview:shootBt];
    
    finishBt = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 60, 60)];
    finishBt.center = CGPointMake(SCREEN_WIDTH-35, 64+preLayerHeight-100);
    ...
    [progressPreView ConanMakeCornerRadius:2 BorderColor:nil BorderWidth:0 BackgroundColor:UIColorFromRGB(0xffc738)];
    ...
    [flashBt ConanMakeCornerRadius:17 BorderColor:nil BorderWidth:0 BackgroundColor:nil];
    ...
    [cameraBt ConanMakeCornerRadius:17 BorderColor:nil BorderWidth:0 BackgroundColor:nil];
...
- (void)mergeAndExportVideosAtFileURLs:(NSMutableArray *)fileURLArray
{
    ...
    [exporter exportAsynchronouslyWithCompletionHandler:^{
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            view.videoWidth =preLayerWidth;
            view.videoHeight =preLayerHeight;
